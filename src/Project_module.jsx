...
const ModuleTitle = ({ fontSize, title = "Projects" }) => {
  return (
    <h1
      style={{
        color: "#fff",
...
export default function Project_module({ 
  title = "Projects", 
  customImages = null,
  className = 'projects',
  contentClassName = 'projects_content'
}) {
      ...
      <div className={contentClassName}>
        <ul style={{
          ...
          <li style={{
            ...
            <ModuleTitle fontSize={fontSize} title={title} />
          </li>
